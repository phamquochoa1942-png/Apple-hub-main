...
-- ==================== AUTO QUEST CHUẨN 2026 (CHỈ 2 THAM SỐ) ====================
function StartQuest(questData)
    ...
    -- Cú pháp ĐÚNG: Chỉ 2 tham số "StartQuest" và tên NPC
    ...
    while true do
        ...
        if _G.AutoFarm then
            pcall(function()
                ...
                -- 2. Nhận quest (phiên bản chuẩn 2026 - 2 tham số)
...
print("📌 Cú pháp đúng: remote:InvokeServer('StartQuest', questData.npc) - CHỈ 2 THAM SỐ")
print("📌 Hướng dẫn:")
