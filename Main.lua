...
-- ==================== BIẾN CẤU HÌNH ====================
_G.AutoFarm = false         -- Bật/tắt toàn bộ farm
_G.BringMob = true          -- Bật/tắt gom quái
...
function TweenToPosition(Position)
    ...
    pcall(function()
        ...
        tween:Play()
        while tween.PlaybackState ~= Enum.PlaybackState.Completed and _G.AutoFarm do 
            task.wait() 
        end
    end)
end
    ...
    while true do
        ...
        if _G.AutoFarm and _G.BringMob then
            pcall(function()
                ...
                local TargetPos = MyPos + Vector3.new(0, _G.BringMobHeight, 0)
                
                for _, v in pairs(workspace:GetChildren()) do
                    pcall(function()
                        local enemy = v:FindFirstChild("HumanoidRootPart") and v or (v:IsA("Folder") and v:FindFirstChildWhichIsA("Model"))
                        ...
                        if enemyHrp and enemyHum and enemyHum.Health > 0 then
                            if (enemyHrp.Position - MyPos).Magnitude <= _G.DistanceMob then
